  ...
  return (
    <nav className="fixed top-18 z-50 flex w-full items-center">
      <div className="ml-18 flex items-center justify-center">
        <h1 className="text-2xl drop-shadow-[0_0_6px_rgba(255,255,255,0.35)]">
          Shrug AI
        </h1>
      </div>
      <div
        className={
          "absolute left-1/2 flex h-18 -translate-x-1/2 transform items-center justify-between gap-6 rounded-full bg-black/10 px-8 shadow-lg ring-1 ring-white/10 backdrop-blur-2xl"
        }
      >
...
const LinkELement = ({ title, page, setPage }: LinkElementProps) => {
  ...
  return (
    ...
    >
      <span className="font-medium drop-shadow-[0_0_6px_rgba(255,255,255,0.25)]">
        {title !== "startForFree"
